...
- As an **analyst**, in charge of follow-up  
- As an **approver**, authorized to validate or reject a subscription

Each subscription follows a defined path, from creation to final signature.
...
A first modal window opens to enter the main subscription information.

#### ⚠️ Create or select an investor

- If you type an investor name **without autocomplete**, a **new investor is automatically created** in the *Diligence* module.  
...
After validating step one, you are redirected to the **subscription questionnaire**.

To share the subscription with the investor, **two fields are mandatory** for the operator:
...
When the subscription status is **“sent to investor”**, it means:

- The signature process **has not started yet**  
- The investor **currently controls the file** but has not clicked **Sign** yet

➡️ In this case, you can **take control back** by clicking the dedicated button in the top-right corner.
...
## 👤 Investor access - Complete subscription information

After receiving the **completion and signature link**, the investor must fill in **all required fields (\*)**.
