...
The **dashboard** displays the list of all existing agreements and amendments.  
It provides a synthetic view of key information:
...
- by **status**: *To validate*, *Sent*, *Signed*, *Completed*, etc.

---

### 2️⃣ Create an agreement
...
### 3️⃣ Complete basic information

Before sending, users enter the **main information**:

- **Distributor contact details**  
- **Required legal information**  
- **Fund/share-related data**

Once completed, the agreement can be **sent to the distributor**.

---

### 4️⃣ Distributor interaction

The **distributor** receives the agreement through the platform and can:
- **complete missing information** (contact details, regulatory data, supporting documents),  
- **review the content**,  
- then proceed with **electronic signature** directly in the interface.

---

### 5️⃣ Tracking and validation

The **contract status** evolves automatically based on process progress:

| **Step** | **Associated status** |
|------------|-------------------|
| Contract creation | Draft |
| Sent to distributor | Sent |
| Signature in progress | In signature |
